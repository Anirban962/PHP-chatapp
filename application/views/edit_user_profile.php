	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid">
			...
			<ul class="nav justify-content-end me-3">
				<li class="nav-item">
					<a class="nav-link" href="<?php echo base_url()?>index.php/Logincontroller/userdashboard">Go Back</a>
				</li>
				<li class="nav-item">
...
<!--edit profile form will paste here-->
<?php 
		...
		<!-- form start -->
			...
			<div class="card-body">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="update_name" value="<?php echo $result->name ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="radio" class="form-check-input" name="gender" value="male"<?php if($result->gender=='male'){echo 'checked';}?>>Male
					<input type="radio" class="form-check-input" name="gender" value="female"<?php if($result->gender=='female'){echo 'checked';} ?>>Female
					<input type="radio" class="form-check-input" name="gender" value="others"<?php if ($result->gender=='others'){echo 'checked';} ?>>Others
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="custom-file">
							...
							<img src="<?php echo base_url().$result->picsource ?>" height="100" width="100">
						</div>
